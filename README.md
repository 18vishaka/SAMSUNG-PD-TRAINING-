...
<u>Step-1</u>: Initially a directory named VLSI is created, inside this directory we cloned vsdflow repository; this repository consists of the required .lib files and verilog codes for practice. 
